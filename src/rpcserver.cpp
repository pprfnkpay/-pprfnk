...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Pprfnk features */
    { "pprfnk",               "masternode",             &masternode,             true,      true,       false },
    { "pprfnk",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "pprfnk",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "pprfnk",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "pprfnk",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "pprfnk",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "pprfnk",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "pprfnk",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use pprfnkd, or the -server option to pprfnk-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
