...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pprfnk Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pprfnk"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Pprfnk Core help message to get a list with possible Pprfnk command-line options"));
