...
RESOURCES += src/qt/pprfnk.qrc src/qt/pprfnk_locale.qrc
TRANSLATIONS += src/qt/locale/pprfnk_bg.ts \
                src/qt/locale/pprfnk_de.ts \
                src/qt/locale/pprfnk_en.ts \
                src/qt/locale/pprfnk_es.ts \
                src/qt/locale/pprfnk_fi.ts \
                src/qt/locale/pprfnk_fr.ts \
                src/qt/locale/pprfnk_it.ts \
                src/qt/locale/pprfnk_ja.ts \
                src/qt/locale/pprfnk_pl.ts \
                src/qt/locale/pprfnk_pt.ts \
                src/qt/locale/pprfnk_ru.ts \
                src/qt/locale/pprfnk_sk.ts \
                src/qt/locale/pprfnk_sv.ts \
                src/qt/locale/pprfnk_vi.ts \
                src/qt/locale/pprfnk_zh_CN.ts \
                src/qt/locale/pprfnk_zh_TW.ts
