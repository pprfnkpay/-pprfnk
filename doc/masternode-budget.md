...
mnbudget prepare proposal-name url payment_count block_start pprfnk_address monthly_payment_pprfnk [use_ix(true|false)]
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` PPRFNK. 
