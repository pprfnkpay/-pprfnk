...
Only requiring some minor changes is pprfnk.cpp.
...
Changes to pprfnk.cpp
----------------------
pprfnk.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
